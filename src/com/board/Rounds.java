...
public class Rounds {
	...
	public static void initSolutions() {
		...
		board1.addChess(new ReceiveChess(Mode.RIGHTRIGHT,true), 0, 0);
		...
		board2.addChess(new ReceiveChess(Mode.LEFTUP,true), 4, 0);
		...
		board3.addChess(new ReceiveChess(Mode.RIGHTRIGHT,true), 0, 0);
		solutions.add(board3);

		Board board4 = new Board(1, 3);
		board4.addChess(new EmitChess(Mode.LEFT), 3, 4);
		board4.addChess(new ReceiveChess(Mode.LEFTDOWN,true), 0, 1);
		...
		board5.addChess(new ReceiveChess(Mode.RIGHTRIGHT,true), 2, 0);
		board5.addChess(new DualReflectorChess(Mode.LEFT), 2, 3);
		board5.addChess(new ReceiveChess(Mode.LEFTDOWN,true), 0, 3);
		...
		board6.addChess(new ReceiveChess(Mode.RIGHTRIGHT,true), 2, 1);
		...
		board7.addChess(new ReceiveChess(Mode.RIGHTRIGHT,true), 4, 2);
		...
		board8.addChess(new ReceiveChess(Mode.RIGHTLEFT,true), 0, 4);
		board8.addChess(new ReceiveChess(Mode.RIGHTLEFT,true), 1, 4);
		...
		board9.addChess(new ReceiveChess(Mode.RIGHTLEFT,true), 2, 3);
		...
		board9.addChess(new ReceiveChess(Mode.LEFTUP,true), 4, 2);
		...
		board10.addChess(new ReceiveChess(Mode.LEFTDOWN,true), 0, 3);
		board10.addChess(new ReceiveChess(Mode.RIGHTRIGHT,true), 3, 3);
		...
		board11.addChess(new ReceiveChess(Mode.RIGHTRIGHT,true), 0, 1);
		...
		board12.addChess(new ReceiveChess(Mode.LEFTUP,true), 4, 3);
		...
		board13.addChess(new ReceiveChess(Mode.RIGHTRIGHT,true), 1, 2);
		board13.addChess(new ReceiveChess(Mode.RIGHTRIGHT,true), 2, 1);
		...
		board13.addChess(new ReceiveChess(Mode.RIGHTLEFT,true), 4, 3);
		...
		board14.addChess(new ReceiveChess(Mode.RIGHTRIGHT,true), 3, 0);
		board14.addChess(new DualReflectorChess(Mode.RIGHT), 3, 2);
		board14.addChess(new ReceiveChess(Mode.LEFTDOWN), 4, 2);
		board14.addChess(new ReceiveChess(Mode.RIGHTLEFT,true), 4, 4);
		...
		board14.addChess(new ReceiveChess(Mode.RIGHTLEFT,true), 0, 4);
		...
		board15.addChess(new ReceiveChess(Mode.LEFTDOWN,true), 0, 3);
		board15.addChess(new ReceiveChess(Mode.RIGHTLEFT), 2, 1);
		board15.addChess(new ReceiveChess(Mode.LEFTUP,true), 3, 1);
		board15.addChess(new ReceiveChess(Mode.RIGHTRIGHT,true), 4, 1);
		...
		board16.addChess(new ReceiveChess(Mode.RIGHTLEFT,true), 0, 3);
		board16.addChess(new ReceiveChess(Mode.LEFTDOWN,true), 1, 0);
		...
		board16.addChess(new ReceiveChess(Mode.LEFTUP,true), 3, 4);
		...
		board17.addChess(new ReceiveChess(Mode.RIGHTRIGHT,true), 1, 0);
		board17.addChess(new ReceiveChess(Mode.RIGHTRIGHT,true), 2, 0);
		board17.addChess(new ReceiveChess(Mode.LEFTUP,true), 4, 3);
		...
		board18.addChess(new ReceiveChess(Mode.LEFTDOWN,true), 2, 0);
		board18.addChess(new ReceiveChess(Mode.LEFTDOWN,true), 3, 0);
		...
		board19.addChess(new ReceiveChess(Mode.RIGHTLEFT,true), 3, 4);
		...
		board19.addChess(new ReceiveChess(Mode.RIGHTRIGHT,true), 2, 1);
		board19.addChess(new ReceiveChess(Mode.RIGHTLEFT), 0, 1);
		board19.addChess(new ReceiveChess(Mode.RIGHTLEFT,true), 0, 2);
		...
		board20.addChess(new ReceiveChess(Mode.LEFTDOWN,true), 0, 1);
		board20.addChess(new ReceiveChess(Mode.RIGHTLEFT,true), 1, 4);
		board20.addChess(new ReceiveChess(Mode.RIGHTLEFT), 2, 2);
		board20.addChess(new ReceiveChess(Mode.LEFTDOWN), 3, 1);
		board20.addChess(new ReceiveChess(Mode.LEFTUP,true), 4, 2);
	...
	public static void initRounds() {
		...
		board1.addChess(new BlockChess(), 2, 0);
		board1.addChess(new ReceiveChess(true), 0, 0);
		...
		board2.addChess(new ReceiveChess(true), 4, 0);
		...
		board3.addChess(new BlockChess(), 4, 4);
		board3.addChess(new ChannelChess(Mode.VERTICAL), 0, 2);
		board3.addChess(new ReceiveChess(true), 0, 0);
		board3.addUnusedChess(new ReceiveChess());
		board3.addUnusedChess(new ReceiveChess());
		rounds.add(board3);

		Board board4 = new Board(1, 3);//6
		board4.addChess(new ReceiveChess(true), 0, 1);
		board4.addChess(new ChannelChess(Mode.VERTICAL), 3, 3);
		...
		board7.addChess(new ReceiveChess(true), 4, 2);
		...
		board8.addChess(new ReceiveChess(true), 0, 4);
		...
		board10.addChess(new ReceiveChess(true), 0, 3);
		board10.addChess(new ReceiveChess(Mode.RIGHTRIGHT,true), 3, 3);
		...
		board12.addChess(new ChannelChess(Mode.HORIZONTAL), 2, 0);
		board12.addChess(new BlockChess(), 4, 0);
		board12.addChess(new ReceiveChess(true), 4, 3);
		...
		board13.addChess(new ReceiveChess(true), 4, 3);
		...
		board14.addChess(new BlockChess(), 3, 1);
		board14.addChess(new ReceiveChess(true), 3, 0);
		board14.addChess(new DualReflectorChess(), 3, 2);
		board14.addChess(new ReceiveChess(), 4, 2);
		board14.addChess(new ReceiveChess(true), 4, 4);
		board14.addChess(new ChannelChess(Mode.HORIZONTAL), 2, 1);
		board14.addChess(new ReceiveChess(true), 0, 4);
		...
		board17.addChess(new ReceiveChess(true), 2, 0);
